...
/**
 * Clase que representa al botón de la operación de substracción de la calculadora.
 * @author Lois Domínguez Domínguez
 */
public class BotonResta extends Boton{
    
    /**
     * Constructor de botones de la operación de substracción de la calculadora.
     */
    public BotonResta(){
        super('-');
