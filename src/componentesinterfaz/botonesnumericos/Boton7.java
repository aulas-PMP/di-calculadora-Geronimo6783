...
/**
 * Clase que representa al botón del número 7 de la calculadora.
 * @author Lois Domínguez Domínguez
 */
public class Boton7 extends Boton{
    
    /**
     * Constructor de botones del número 7 de la calculadora.
     */
    public Boton7(){
        super('7');
    ...
    private class EscuchadorRaton implements MouseListener{
        ...
        public void mouseClicked(MouseEvent me) {
            if(me.getButton() == MouseEvent.BUTTON1){
                ...
                Calculadora.panel.mostrarCaracter('7');
            }
        }
